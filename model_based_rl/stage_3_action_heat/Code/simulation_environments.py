...
def bestest_hydronic_heat_pump():
   ...
   #obs = env.reset(options = 1)[0] 
    ...
    no_of_agent_updates = 2 #was 2 (Good one), 5(Failed), 3(Failed)
    ...
    env_attributes = {
                         ...
                         "points":points,
                         "agent_h_size": str(100), 
                         "n_training_episodes": str(500), 
                         "max_t": str(max_episode_length // step_period),    
                         "gamma": str(0.99),
                          "actor_lr": 0.00005  ,   # Used this value from episode 6 onwards 0.000005
                          "critic_lr": 0.0002,     # Used this value from episode 6 onwards 0.00002
                          "no_of_action_types":len(actions),
                          "buffer_size": 35000, #was 350000
                          "synthetic_buffer_size": 350000,
                          "batch_size": 1024,
                          "no_of_updates": no_of_agent_updates,
    ...
    env_model_attributes = {
                        ...
                        "hidden_layers": 32,
                         ...
                         "task_index": 0,
                         "env_train_buffer_size": 4000, #was 1320
                         "batch_size": 20, 
                          "no_of_updates": 1,
                         "train_test_ratio":0.80,
                         "no_of_synthetic_samples": 10,
                         "no_of_models": 100
