...
def save_models(i_episode, exp_path, actor,actor_optimizer,critic_1, critic_optimizer_1 , critic_2 , critic_optimizer_2, agent_actual_memory, env_memory_train, agent_synthetic_memory, reward_model, realT_zon_model, env_type):
    ...
    with open(exp_path + '/Models/'+"env_train_data.pkl" , "wb") as f:
      pickle.dump(env_memory_train, f)  
    
    with open(exp_path + '/Models/'+"agent_synthetic_memory.pkl" , "wb") as f:
      pickle.dump(agent_synthetic_memory, f)  
    
    with open(exp_path + '/Models/'+"reward_model.pkl" , "wb") as f:
      pickle.dump(reward_model, f)  
    
    with open(exp_path + '/Models/'+"realT_zon_model.pkl" , "wb") as f:
      pickle.dump(realT_zon_model, f)  
    
    
    
def save_train_results(i_episode, metrics_path, env , exp_path, points, train_time, episode_rewards, plot_scores_train_extrinsic, episode_actor_loss, episode_critic_1_loss, episode_critic_2_loss, q_predictions, env_type):
    ...
    with open(metrics_path, 'a', newline='') as file:
        ...
        if i_episode % 1 == 0:
             ...
             tmp = ['Train', i_episode, train_time, max_episode_length/24/3600,  train_date.strftime("%B %d, %Y") , np.mean(episode_actor_loss), np.mean(episode_critic_1_loss), np.mean(episode_critic_2_loss) , np.mean(q_predictions) ] +[kpis['cost_tot'] , kpis['emis_tot'], kpis['ener_tot'], kpis['idis_tot'], kpis['pdih_tot'],kpis['pele_tot'],kpis['pgas_tot'],kpis['tdis_tot'] ] + [list(plot_scores_train_extrinsic.values())[-1] ]
             writer.writerow(tmp )
...
def save_test_results(i_episode, metrics_path, env, state_mask, exp_path, points, actor, env_type):
    ...
    with open(metrics_path, 'a', newline='') as file:
            ...
            tmp = ['Test', i_episode, test_jan17_time, max_episode_length/24/3600,  test_date.strftime("%B %d, %Y") , "NA", "NA", "NA", "NA" ] +[kpis['cost_tot'] , kpis['emis_tot'], kpis['ener_tot'], kpis['idis_tot'], kpis['pdih_tot'],kpis['pele_tot'],kpis['pgas_tot'],kpis['tdis_tot'] ] + [list(plot_scores_test_extrinsic_jan17.values())[-1] ] 
            ...
            tmp = ['Test', i_episode, test_apr19_time, max_episode_length/24/3600,  test_date.strftime("%B %d, %Y") , "NA", "NA", "NA", "NA" ] +[kpis['cost_tot'] , kpis['emis_tot'], kpis['ener_tot'], kpis['idis_tot'], kpis['pdih_tot'],kpis['pele_tot'],kpis['pgas_tot'],kpis['tdis_tot'] ] + [list(plot_scores_test_extrinsic_apr19.values())[-1] ] 
            ...
            tmp = ['Test', i_episode, test_nov15_time, max_episode_length/24/3600,  test_date.strftime("%B %d, %Y") , "NA", "NA", "NA", "NA" ] +[kpis['cost_tot'] , kpis['emis_tot'], kpis['ener_tot'], kpis['idis_tot'], kpis['pdih_tot'],kpis['pele_tot'],kpis['pgas_tot'],kpis['tdis_tot'] ] + [list(plot_scores_test_extrinsic_nov15.values())[-1] ] 
            ...
            tmp = ['Test', i_episode, test_dec08_time, max_episode_length/24/3600,  test_date.strftime("%B %d, %Y") , "NA", "NA", "NA", "NA" ] +[kpis['cost_tot'] , kpis['emis_tot'], kpis['ener_tot'], kpis['idis_tot'], kpis['pdih_tot'],kpis['pele_tot'],kpis['pgas_tot'],kpis['tdis_tot'] ] + [list(plot_scores_test_extrinsic_dec08.values())[-1] ] 
