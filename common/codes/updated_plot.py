...
def test_agent(env, env_attributes, data_params, model_params, actor, start_time ):
    ...
    if plot:
         plt, day_of_year = get_plots(env, rewards, points, save_to_file=save_to_file, log_dir=log_dir,  testcase=testcase)
    ...
    return observations, actions, rewards, kpis,  plt, day_of_year, results


def get_plots(env, rewards, points, log_dir, save_to_file, testcase):
