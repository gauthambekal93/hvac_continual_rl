...
if __name__ == '__main__':
    ...
    data_config_path = os.path.join(project_root, "configuration_files","data", "task_2","action_heat_fan_cool.json") 
    
    model_config_path = os.path.join(project_root, "configuration_files","models", "task_2", "model_based_sac", "0.json") 
